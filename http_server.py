...
def parse_request(request):
    ...
    print('path out of parse_request() = {}'.format(path))
    if method != "GET":
        ...
        while True:
            ...
            try:
                ...
                try:
                    ...
                    # If parse_request raises NotImplementedError then method_not_allowed()
                    #   use the content and mimetype from response_path to build a
                    #   response_ok.
                    response = response_method_not_allowed()
                except NameError:
                    # if response_path raises NameError then response_not_found()
